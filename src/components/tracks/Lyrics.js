				...
				<React.Fragment>
					...
					<ul className="list-group mt-3">
						<li className="list-group-item">
							<strong>Albumm ID</strong>: 
							{ track.album_id }
						</li>
						<li className="list-group-item">
							<strong>Song Genre</strong>:{' '}
							{ track.primary_genres.music_genre_list.length === 0 ? 'No Genre Availble' : track.primary_genres.music_genre_list[0].music_genre.music_genre_name }
						</li>
						<li className="list-group-item"><strong>Song Genre</strong>: 
